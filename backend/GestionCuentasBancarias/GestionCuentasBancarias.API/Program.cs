...
builder.Services.AddScoped<IReporteChequeraService, ReporteChequeraService>();
builder.Services.AddScoped<IReporteChequeraRepository, ReporteChequeraRepository>();
